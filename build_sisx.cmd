...
echo   [CC] GameSelector.cpp
"%CC%" %D% %F% -include "%G%" %I% -o "%OBJ%\GameSelector.o" "%SD_LWN%\Widget\GameSelector.cpp"
if errorlevel 1 (echo   [ERROR] compile FAILED: GameSelector.cpp & exit /b 1)
echo   [CC] LawnApp.cpp
