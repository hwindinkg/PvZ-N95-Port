...
enum CursorType
{
    ...
    CURSOR_TYPE_POINTER,
    CURSOR_TYPE_NEXT_GARDEN
};

// Legacy cursor constant
...
enum GameMode
{
    ...
    GAMEMODE_CHALLENGE_TREE_OF_WISDOM,
...
enum ParticleEffect
{
    ...
    PARTICLE_ZOMBIE_SURPRISE,
    PARTICLE_ZOMBIE_BURNING,
    PARTICLE_TUTORIAL_ARROW,
...
enum PlantingReason
{
    ...
    PLANTING_NOT_ON_LAWN,
    PLANTING_NOT_ON_POT,
    PLANTING_NOT_PASSED,
    PLANTING_NOT_ENOUGH_SUN,
    PLANTING_OK_PASS
};
enum PlantRowType
{
...
enum RenderLayer
{
    ...
    RENDER_LAYER_PROJECTILE_SHADOW = 550000,
...
enum SeedType
{
    // Order must match gPlantDefs array in Plant.cpp (original PopCap ordering)
    SEED_PEASHOOTER = 0,
    SEED_SUNFLOWER = 1,
    SEED_CHERRYBOMB = 2,
    SEED_WALLNUT = 3,
    ...
    SEED_GATLINGPEA = 34,
    SEED_IMITATER = 35,
    SEED_EXPLODE_O_NUT = 36,
    SEED_GIANT_WALLNUT = 37,
    SEED_SPROUT = 38,
    SEED_LEFTPEATER = 39,
    // Additional plant types not in the main gPlantDefs array
    SEED_PUFFSHROOM = 40,
    SEED_JALAPENO = 41,
    SEED_TALLNUT = 42,
    SEED_SEASHROOM = 43,
    SEED_PLANTERN = 44,
    SEED_FLOWERPOT = 45,
    SEED_INSTANT_COFFEE = 46,
    SEED_UMBRELLA = 47,
    SEED_MAGNETSHROOM = 48,
    SEED_TWINSUNFLOWER = 49,
    SEED_GLOOMSHROOM = 50,
    SEED_CATTAIL = 51,
    SEED_WINTERMELON = 52,
    SEED_GOLD_MAGNET = 53,
...
// Aliases for PopCap underscore naming convention (used in plant.cpp)
#define SEED_POTATOE_MINE    SEED_POTATOMINE
#define SEED_SNOW_PEA        SEED_SNOWPEA
#define SEED_GRAVE_BUSTER    SEED_GRAVEBUSTER
#define SEED_SCAREDY_SHROOM  SEED_SCAREDYSHROOM
#define SEED_ICE_SHROOM      SEED_ICESHROOM
#define SEED_DOOM_SHROOM     SEED_DOOMSHROOM
#define SEED_LILY_PAD        SEED_LILYPAD
#define SEED_TANGLE_KELP     SEED_TANGLEKELP
#define SEED_PUMPKIN         SEED_PUMPKINSHELL
#define SEED_SPLIT_PEA       SEED_SPLITPEA
#define SEED_CABBAGE_PULT    SEED_CABBAGEPULT
#define SEED_KERNEL_PULT     SEED_KERNELPULT
#define SEED_MELON_PULT      SEED_MELONPULT
#define SEED_COB_CANNON      SEED_COBCANNON
#define SEED_GARLIC2         SEED_GARLIC2
#define SEED_UPGRADE_REPEATER SEED_GATLINGPEA
enum ShieldType
{
    SHIELDTYPE_NONE,
    SHIELDTYPE_DOOR,
...
enum StoreItem
{
    ...
    STORE_ITEM_SHOVEL,
    STORE_ITEM_GLOVE,
    STORE_ITEM_MONEY_SIGN,
    STORE_ITEM_WHEELBARROW,
    NUM_STORE_ITEMS
};
enum StorePages
{
...
enum TutorialState
{
    ...
    TUTORIAL_LEVEL_1_PICK_SEEDS = 31
};
enum UnlockingState
{
    UNLOCK_OFF,
...
// ---------------------------------------------------------------------------
// ID typedefs (plain enums with a single sentinel value)
// ---------------------------------------------------------------------------
...
// ParticleSystemID: typedef int — used as ID handle, not enum
typedef int ParticleSystemID;
#define PARTICLESYSTEMID_NULL ((ParticleSystemID)-1)
enum PlantID           { PLANTID_NULL };
// ReanimationID: typedef int — used as ID handle, not enum
typedef int ReanimationID;
#define REANIMATIONID_NULL ((ReanimationID)-1)
enum ZombieID          { ZOMBIEID_NULL };

// ---------------------------------------------------------------------------
// Advice types for Crazy Dave help system
// ---------------------------------------------------------------------------
enum AdviceType
{
    ADVICE_NONE = -1,
    ...
    ADVICE_SPIKEWEED = 7,
    ADVICE_CHERRYBOMB = 8,
    ADVICE_CLICK_ON_SUN = 9,
    ADVICE_UNLOCKED_MODE = 10,
    ADVICE_CLICKED_ON_COIN = 11,
    ADVICE_CLICKED_ON_SUN = 12,
    ADVICE_I_ZOMBIE_EAT_ALL_BRAINS = 13,
