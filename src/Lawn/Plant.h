...
public:
    ...
    void                    DoSpecial();
    void                    Fire(Zombie* theTargetZombie, int theRow, PlantWeapon thePlantWeapon = WEAPON_PRIMARY);
    Zombie*                 FindTargetZombie(int theRow, PlantWeapon thePlantWeapon = WEAPON_PRIMARY);
    void                    Die();
    void                    UpdateProductionPlant();
    void                    UpdateShooter();
    bool                    FindTargetAndFire(int theRow, PlantWeapon thePlantWeapon = WEAPON_PRIMARY);
    void                    LaunchThreepeater();
    static Image*           GetImage(SeedType theSeedType);
    static int              GetCost(SeedType theSeedType, SeedType theImitaterType = SEED_NONE);
    static std::string       GetNameString(SeedType theSeedType, SeedType theImitaterType = SEED_NONE);
    static std::string       GetToolTip(SeedType theSeedType);
    static int              GetRefreshTime(SeedType theSeedType, SeedType theImitaterType = SEED_NONE);
    ...
    int                     GetDamageRangeFlags(PlantWeapon thePlantWeapon = WEAPON_PRIMARY);
    Rect                    GetPlantRect();
    Rect                    GetPlantAttackRect(PlantWeapon thePlantWeapon = WEAPON_PRIMARY);
    ...
    static bool             CanPlaceOnHighGround(SeedType theSeedType) { (void)theSeedType; return false; }
    bool                    MouseHitTest(int x, int y, HitResult* theHitResult) { (void)x; (void)y; (void)theHitResult; return false; }
    void                    BeginCobCannonFire(int x, int y) { (void)x; (void)y; }
    void                    RemoveEffects();
...
extern PlantDefinition gPlantDefs[NUM_SEED_TYPES];
