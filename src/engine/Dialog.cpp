...
const char* Sexy::DIALOG_YES_STRING				= "YES";
const char* Sexy::DIALOG_NO_STRING				= "NO";
const char* Sexy::DIALOG_OK_STRING				= "OK";
const char* Sexy::DIALOG_CANCEL_STRING			= "CANCEL";
